...
var App = React.createClass({displayName: "App",
      ...
      React.createElement("div", {className: "container"}, 
        React.createElement("div", {className: "row"}, 
          React.createElement("div", {className: "col-lg-12 hero"}, 
            React.createElement("h1", null, React.createElement("code", null, "<JSXView/>"))
          )
        ), 

        React.createElement("div", {className: "row"}, 
          React.createElement("div", {className: "col-lg-12 hero"}, 
            React.createElement("h3", null, "Check out the code for this demo ", React.createElement("a", {href: "https://github.com/MandarinConLaBarba/react-jsx-view/blob/master/example/App.jsx"}, "here"), ".")
          )
        ), 
        ...
        React.createElement("div", {className: "row"}, 
          ...
          React.createElement("div", {className: "col-lg-6"}, 
            React.createElement("div", {className: "panel panel-default"}, 
              ...
              React.createElement("div", {className: "panel-body"}, 
                React.createElement("h5", null, "Hover over the ", React.createElement("code", null, "style"), " props to inspect."), 
  ...
  _getButtonNode: function (number, text) {
    ...
    return React.createElement("button", {style: {color: "#" + colors[number], backgroundColor: "#FFEDDB"}, key: "button-" + number, 
      className: className, 
...
},{"../index":3,"react":166,"react/lib/cx":123}],2:[function(require,module,exports){
var React = require('react');
...
},{"./App.jsx":1,"react":166}],3:[function(require,module,exports){
module.exports = require('./src/JSXView.jsx');


},{"./src/JSXView.jsx":167}],4:[function(require,module,exports){
...
var JSXView = React.createClass({displayName: "JSXView",
  ...
  _getChildren: function (children) {
    ...
    return React.Children.map(children, function (child) {
      ...
      return React.createElement("div", {style: styles}, markupLiteral);
    }.bind(this));
  ...
  _getEmptyNode: function (child) {
    ...
    return React.createElement("div", null, "<" + displayName + "></" + displayName + ">");
  },
  ...
  _getOpeningNode: function (child, selfClosing) {
    ...
    if (attribs.length > 0) {
      ...
      attributesNode = (
        React.createElement("div", {style: {marginLeft: margin}}, 
          attribs
        ));
    } else {
      header += footer;
  ...
  _getClosingNode: function (child) {
    return React.createElement("div", null, "</" + this._getDisplayName(child) + ">");
  },
